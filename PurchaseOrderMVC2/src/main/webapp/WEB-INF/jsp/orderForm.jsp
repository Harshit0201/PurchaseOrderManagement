...
<div class="alert alert-danger m-auto mt-3 mb-3 p-0 w-50" id="formError" style="margin:10px;border:0px;">
	...
	<h2 class="text-center mt-3 mb-4 " id="titleOrder">PurchaseOrder Form</h2>
	<div id="orderContainer" class="ml-3 mb-3 mr-3 mt-3  d-flex justify-content-center ">
	
		<form:form action="validAdd" modelAttribute="order" name="form" id="orderForm" class="form-group text-center border border-5 border-darker rounded-4 shadow-lg mb-0 bg-white" method="post">
			...
			<div class="text-center rounded-5 p-4">
				...
				<form:input path="orderId" type="number" name="orderId" id="orderId"  class="order-input col-sm-4 mb-0 form-control d-inline-block h6" min="1" placeholder="Order Id" />
				...
				<div class="text-right">
					<button type="submit" id="btnSubmit" class="btn btnForm btn-primary  h6"> Add <i class="fa-solid fa-plus"></i></button>
